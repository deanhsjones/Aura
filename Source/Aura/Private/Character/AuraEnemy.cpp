...
void AAuraEnemy::BeginPlay()
{
	...
	//nb it's OK to use cast in this situation since we know enemy will use this attribute set, but other projects might use separate AS and need to check the prt here (castchecked)
